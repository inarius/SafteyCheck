 ...
 * Built with [Modules: 'template'; Themes: 'clean']
 */
(function ($, Backbone, _) {
    var emptyFn = function () {},
        Notifier = Backbone.Notifier = Backbone.Model.extend({
            defaults: {
                ...
                'theme': 'clean',		// default theme for notifications (currently available: 'plastic' / 'clean').
...
})(this.jQuery || this.Zepto, Backbone, _);
...
})(Backbone.Notifier, this.jQuery || this.Zepto, _);